...
aa = pd.read_csv('M1-realdat-u.csv')
db1=aa['bp1'].values
db1.sort()
db3=aa['bp3'].values
db3.sort()
...
df = pd.read_csv('M1-realdat-u.csv')
...
plt.tight_layout()
plt.savefig("M1Traceplot.pdf", format="pdf", bbox_inches="tight")
plt.savefig("M1Traceplot.jpg",bbox_inches="tight")
plt.show()

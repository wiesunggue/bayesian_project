...
####################################################
B_p = [-2.05,0.06,3.37,0.14]
B_q = [-0.5,0.72,0.60,0.90]
params = B_p + B_q
####################################################
d = len(params)
...
u_colnames = ["bp" + str(num1) for num1, in zip([0,1,3,4])]+[
    "bq" + str(num1) for num1, in zip([0,1,8,9])] # 변수명 재정의(논문식 표기를 위함)
